...
*/
$ly->config['debug']['getupmvc'] = false;
...
* Set database(s).
*/
$ly->config['database'][0]['dsn'] = 'sqlite:' . GETUPMVC_SITE_PATH . '/data/.ht.sqlite';
...
$ly->config['session_key'] = 'getupmvc';
...
$ly->config['controllers'] = array(
  ...
  'my'        => array('enabled' => true,'class' => 'CCMycontroller'), //My own site
);
...
* Template files can reside in the parent or current theme, the CGetupMVC::ThemeEngineRender()
...
*
* path: Path to current theme, relativly GETUPMVC_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
...
$ly->config['theme'] = array(
  ...
  'data' => array(
    ...
    'logo_width' => 80,
    'logo_height' => 80,
    'footer' => '<p>GetupMVC &copy; by Karoline Petersson and Mikael Roos (mos@dbwebb.se)</p>',
  ),
);
