<?php
/**
* A model for managing GetupMVC modules.
*
...
* Properties
*/
  private $getupmvcCoreModules = array('CGetupMVC', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $getupmvcCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isGetupMVCCore'] = in_array($rc->name, $this->getupmvcCoreModules);
      $details['isGetupMVCCMF'] = in_array($rc->name, $this->getupmvcCMFModules);
