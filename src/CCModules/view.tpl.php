...
<tbody>
<tr><td>Part of GetupMVC Core modules</td><td><?=$module['isGetupMVCCore']?'Yes':'No'?></td></tr>
<tr><td>Part of GetupMVC CMF modules</td><td><?=$module['isGetupMVCCMF']?'Yes':'No'?></td></tr>
