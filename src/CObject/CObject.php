<?php
/**
* Holding a instance of CGetupMVC to enable use of $this in subclasses and provide some helpers.
*
...
/**
* Wrapper for same method in CGetupMVC. See there for documentation.
*/
