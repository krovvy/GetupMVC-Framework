<?php
/**
* Main class for GetupMVC, holds everything.
*
* @package GetupMVCCore
*/
class CGetupMVC implements ISingleton {
...
$ly = &$this;
    require(GETUPMVC_SITE_PATH.'/config.php');
...
* @return CGetupMVC The instance of this class.
*/
public static function Instance() {
if(self::$instance == null) {
self::$instance = new CGetupMVC();
}
...
*/
  public function ThemeEngineRender() {
    ...
    $themePath = GETUPMVC_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = GETUPMVC_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $ly = &$this;
    // First the default GetupMVC themes/functions.php
    include(GETUPMVC_INSTALL_PATH . '/themes/functions.php');
