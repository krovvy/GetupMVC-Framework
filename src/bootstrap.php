...
$file1 = GETUPMVC_SITE_PATH . $classFile;
$file2 = GETUPMVC_INSTALL_PATH . $classFile;
if(is_file($file1)) {
require_once($file1);
...
function exceptionHandler($e) {
  echo "GetupMVC: Uncaught exception: <p>" . $e->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
}
...
function htmlEnt($str, $flags = ENT_COMPAT) {
  return htmlentities($str, $flags, CGetupMVC::Instance()->config['character_encoding']);
}
